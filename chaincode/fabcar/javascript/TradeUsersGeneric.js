...
class TraderContract extends Contract {
    ...
    async initLedger(ctx) {
        ...
        const traders = [
            { id: '1', name: 'Exporter1', userType: 'Exporter', phone: '1234567890', address: '123 Main St', registrationNo: 'EXP001', updates: [] },
            { id: '2', name: 'Shipper1', userType: 'Shipper', phone: '9876543210', address: '456 Oak St', registrationNo: 'SHIP001', updates: [] },
            { id: '3', name: 'Logistics1', userType: 'Logistics', phone: '5678901234', address: '789 Maple St', registrationNo: 'LOG001', updates: [] },
            // Add more trader types as needed
        ];
